...
def home(request):
    ...
    # default 10 MB if not set in settings.py
    ...
    # --- count before pagination for "N matches" ---
    try:
    ...
    # --- taxonomy enrichment for the visible page (resolver ensures "Unknown" fallbacks) ---
    for b in beetles_page.object_list:
        ...
        # Non-persistent attributes for template use
